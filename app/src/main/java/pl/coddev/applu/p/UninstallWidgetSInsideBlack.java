 ...
 */
public class UninstallWidgetSInsideBlack extends UninstallWidgetS {
    ...
    RemoteViews getRemoteViews(Context context) {
        return new RemoteViews(context.getPackageName(), R.layout.widget_s_layout_inside_theme_black);
    }
