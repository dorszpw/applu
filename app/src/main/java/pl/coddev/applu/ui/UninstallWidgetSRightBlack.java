 ...
 */
public class UninstallWidgetSRightBlack extends UninstallWidgetS {
    ...
    RemoteViews getRemoteViews(Context context) {
        return new RemoteViews(context.getPackageName(), R.layout.widget_s_layout_right_theme_black);
    }
