 ...
 */
public class UninstallWidgetMRightWhite extends UninstallWidgetM {
    ...
    RemoteViews getRemoteViews(Context context) {
        return new RemoteViews(context.getPackageName(), R.layout.widget_m_layout_right_theme_white);
    }
